...
# Usage: ./add_tickerq_migration.sh <MigrationName>
...
if [ -z "$1" ]; then
    ...
    echo "Usage: ./add__tickerq_migration.sh <MigrationName>"
    echo "Example: ./add_tickerq_migration.sh InitialCreate"
    exit 1
fi
